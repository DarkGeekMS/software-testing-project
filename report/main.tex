...
\input{sections/Assert}

\section{Assertions explanations}
\label{sec:explainations}
\input{sections/Fail_definition}

\section{Exceptions \& Warnings}
\label{sec:exceptions}
\input{sections/Exceptions_Warnings}

\section{Fixtures}
\label{sec:fixtures}
\input{sections/Fixtures}

\section{Skip and Xfail}
\label{sec:skip_xfail}
\input{sections/Skip_XFail}
